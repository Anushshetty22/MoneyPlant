...
Phase 3.6 now extends the shared market-data model into Angel One binary live
message decoding. Phase 3.1 froze the canonical/provider identity, provider capability,
